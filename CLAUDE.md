[CLAUDE.md](https://github.com/user-attachments/files/29130309/CLAUDE.md)
...
- Käyttäjiä: Tuomo (omistaja), Sanna (toimisto/vaimo), 2 työntekijää, Tomi (ylläpito/kehittäjä)
